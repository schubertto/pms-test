...
try:
    ...
    sprints = [
        ("스프린트 1: 기획 및 API 설계", "2026-06-01", "2026-06-15", False),
        ("스프린트 2: UI 디자인 및 백엔드 개발", "2026-06-16", "2026-06-30", True),
        ("스프린트 3: 프론트 연동 및 QA", "2026-07-01", "2026-07-15", False)
    ]
    for s in sprints:
        cursor.execute("""
    ...
    cursor.execute("""
        ...
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) RETURNING id;
    """, ("웹 퍼블리싱 및 CSS 구축", "HTML 마크업 및 Tailwind/CSS 스타일 가이드 구현", "2.2", "예정", 2, member_map["팀원5"], sprint_map[2], "2026-06-23", "2026-06-30", 0, t2_1_id))
